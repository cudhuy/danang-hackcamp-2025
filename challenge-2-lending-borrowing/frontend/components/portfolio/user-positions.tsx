...
export default function UserPositions() {
	...
	const loanDetails = contractData?.[1]?.result as
	...
	return (
		<div className='space-y-6'>
						...
						<div className='grid grid-cols-1 md:grid-cols-3 gap-4'>
							<div>
								...
								<p className='text-lg font-semibold'>
									{formatUnits(lockedCollateral, collateralDecimals || 18)}{' '}
									{collateralSymbol}
								</p>
							</div>
							...
							<div>
								...
								<div className='flex items-center gap-2'>
									...
									<Badge
										variant={
											healthFactor >= BigInt(150) ? 'default' : 'destructive'
										}
										className='text-xs'
									>
						...
						{healthFactor < BigInt(120) && (
							<div className='flex items-center gap-2 p-3 bg-yellow-50 dark:bg-yellow-950 rounded-md'>
								...
								<p className='text-sm text-yellow-800 dark:text-yellow-200'>
									Your position is at risk. Consider adding more collateral or
			...
			{/* No Positions */}
			{!hasActiveLoan &&
				(!depositedCollateral || depositedCollateral === BigInt(0)) && (
					<Card>
